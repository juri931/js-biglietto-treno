...
document.getElementById("total").innerHTML="Il costo della corsa sarà di: €"+total+".";

console.log("Il costo della corsa sarà di: €"+total+".");

// 5. Sconto minorenni 20%
let discount20 = (Math.round(total * 0.20));

if (age<18){
  total = (total - discount20);
  document.getElementById('discount').innerHTML = "Il tuo sconto del 20% è di: €" + discount20 + ".";
}
...
if (age > 65){
  ...
  document.getElementById('discount').innerHTML = "Il tuo sconto del 40% è di: €" + discount40 + ".";
}
...
// 7. Stampa output
document.getElementById('totalFinal').innerHTML = "Il totale del biglietto è di: €" + total;